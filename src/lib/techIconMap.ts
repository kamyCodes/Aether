...
import {
  SiTypescript, SiJavascript, SiPython, SiReact, SiVuedotjs, SiSvelte,
  SiNodedotjs, SiNextdotjs, SiDeno, SiBun, SiVite, SiWebpack,
  SiEsbuild, SiRollupdotjs, SiBabel, SiJest, SiVitest, SiCypress,
  SiGooglechrome, SiTailwindcss, SiSass, SiHtml5, SiMarkdown, SiGraphql,
  SiMongodb, SiPostgresql, SiRedis, SiMysql, SiSqlite, SiPrisma,
  SiDocker, SiKubernetes, SiGit, SiGithub, SiGitlab, SiRust, SiGo,
  SiC, SiCplusplus, SiSharp, SiOpenjdk, SiKotlin, SiSwift, SiPhp,
  SiRuby, SiLua, SiDart, SiFlutter, SiNpm, SiYarn, SiPnpm,
  SiTurborepo, SiEslint, SiPrettier, SiFigma, SiElectron, SiExpress,
  SiSocketdotio, SiCss, SiDotnet, SiGnubash, SiNushell,
} from 'react-icons/si';
